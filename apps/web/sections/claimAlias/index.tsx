                            ...
                            <div className="flex-1 flex flex-col justify-between s p-6">
                                <div>
                                    ...
                                    <p className="py-6 text-justify">
                                        ...
                                        This <em>Alias</em> is a small data container on the Signum Network and belongs
                                        exclusively to you.
                                        The data inside the <em>Alias</em> can be changed, e.g. with the
                                        <a className="link" href="https://signumswap.com" rel="noreferrer noopener"
                                           target="_blank">&nbsp;SignumSwap - DeFi Portal</a> or the
                                        <a className="link" href="https://phoenix-wallet.rocks" rel="noreferrer noopener"
                                           target="_blank">&nbsp;Signum Phoenix Wallet</a>.
                                    </p>
                                    <div className="text-left text-xs flex flex-row items-center mb-6">
                                        <FiAlertCircle className="opacity-60 mr-2" size={28}/>
                                        Mind that it's necessary to have a small balance on your Signum Account. Maintaining
                                        an Alias costs you 12.5 SIGNA all three months and will be charged automatically.

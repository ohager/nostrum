              ...
              <div className="flex-1 flex flex-col justify-between s p-6">
                <div>
                  ...
                  <p className="py-6 text-justify">
                    When you can claim your name, you will get a so called{" "}
                    <em>Alias</em>. This <em>Alias</em> is a small data
                    container on the Signum Network and belongs exclusively to
                    you. The data inside the <em>Alias</em> can be changed, e.g.
                    with the
                    <a
                      className="link"
                  ...
                  <div className="text-left text-xs flex flex-row items-center mb-6">
                    ...
                    all three months and will be charged automatically. The
                    first three months are free!
                  </div>
                </div>
                <div className="text-center">
                  <button className="btn btn-lg btn-accent" onClick={onNext}>
                    Claim Now
                  </button>
                </div>
              </div>
